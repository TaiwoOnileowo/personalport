  ...
  return (
    <div className="max-w-7xl relative mx-auto py-20 md:py-40 px-4 w-full  left-0 top-0">
      <h1 className=" text-4xl md:text-5xl lg:text-7xl font-bold dark:text-white">
        Visual ShowCase <br />
        of <span className="text-purple">My Projects</span>
      </h1>
      <p className="max-w-2xl text-base md:text-xl mt-8 dark:text-neutral-200">
        I love building stuff and solving problems with technology. Get a visual
        idea of the websites and projects I've worked on. Let&apos;s create
